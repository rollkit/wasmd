...
echo "wasmd start --rollkit.aggregator --rollkit.da_address http://localhost:7980 --rpc.laddr tcp://0.0.0.0:36657 --grpc.address 0.0.0.0:9290 --p2p.laddr \"0.0.0.0:36656\" --minimum-gas-prices=\"0.025urosm\" --rollkit.block_time 200ms" >> restart-wasmd.sh
